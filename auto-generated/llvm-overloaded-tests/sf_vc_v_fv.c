...
vuint32m1_t test_sf_vc_v_fv_u32m1(int bit_field26, vuint32m1_t vs2, float fs1,
                                  size_t vl) {
  return __riscv_sf_vc_v_fv(0, vs2, fs1, vl);
}
...
vuint32m2_t test_sf_vc_v_fv_u32m2(int bit_field26, vuint32m2_t vs2, float fs1,
                                  size_t vl) {
  return __riscv_sf_vc_v_fv(0, vs2, fs1, vl);
}
...
vuint32m4_t test_sf_vc_v_fv_u32m4(int bit_field26, vuint32m4_t vs2, float fs1,
                                  size_t vl) {
  return __riscv_sf_vc_v_fv(0, vs2, fs1, vl);
}
...
vuint32m8_t test_sf_vc_v_fv_u32m8(int bit_field26, vuint32m8_t vs2, float fs1,
                                  size_t vl) {
  return __riscv_sf_vc_v_fv(0, vs2, fs1, vl);
}
...
vuint64m1_t test_sf_vc_v_fv_u64m1(int bit_field26, vuint64m1_t vs2, double fs1,
                                  size_t vl) {
  return __riscv_sf_vc_v_fv(0, vs2, fs1, vl);
}
...
vuint64m2_t test_sf_vc_v_fv_u64m2(int bit_field26, vuint64m2_t vs2, double fs1,
                                  size_t vl) {
  return __riscv_sf_vc_v_fv(0, vs2, fs1, vl);
}
...
vuint64m4_t test_sf_vc_v_fv_u64m4(int bit_field26, vuint64m4_t vs2, double fs1,
                                  size_t vl) {
  return __riscv_sf_vc_v_fv(0, vs2, fs1, vl);
}
...
vuint64m8_t test_sf_vc_v_fv_u64m8(int bit_field26, vuint64m8_t vs2, double fs1,
                                  size_t vl) {
  return __riscv_sf_vc_v_fv(0, vs2, fs1, vl);
}
